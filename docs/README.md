...
This folder is the long-form documentation for the calculator. The root [README](../README.md) stays the short path: requirements, how to run, API examples, and the prompts used for the assignment.
...
| [Decisions](decisions.md) | Design choices and explicit non-goals |
| [Prompts](prompts.md) | Pointer to the assignment prompt log |
